...
Feature: Submission types
  ...
  @javascript
  Scenario: Test peering settings validation
    Given I am on "Test" course homepage with editing mode on
    And I add a "peering" to section "0"
    When I set the following fields to these values:
      | peering name               | Test peering |
    ...
    And I press "Save and display"
    Then I should see "Setup phase" in the "h3#mod_peering-userplanheading" "css_element"
  ...
  Scenario: All submission fields required
    Given the following "activities" exist:
      ...
      | peering | All required | TEST   | peering1 | 2                  | 2                  |
    And I am on the "All required" "peering activity" page
    ...
    And I set the following fields to these values:
      | Attachment         | mod/peering/tests/fixtures/moodlelogo.png |
    And I press "Save changes"
  ...
  Scenario: Online text required, file attachment optional
    Given the following "activities" exist:
      | activity | name          | course | idnumber  | submissiontypetext | submissiontypefile |
      | peering | Optional file | TEST   | peering1 | 2                  | 1                  |
    And I am on the "Optional file" "peering activity" page
    And I follow "Switch to the submission phase"
    And I press "Continue"
    And I press "Add submission"
    And I set the field "Title" to "Test submission"
  ...
  Scenario: Online text optional, file attachment required
    Given the following "activities" exist:
      | activity | name          | course | idnumber  | submissiontypetext | submissiontypefile |
      | peering | Optional text | TEST   | peering1 | 1                  | 2                  |
    And I am on the "Optional text" "peering activity" page
    And I follow "Switch to the submission phase"
    And I press "Continue"
    And I press "Add submission"
    And I set the field "Title" to "Test submission"
  ...
  Scenario: Online text only
    Given the following "activities" exist:
      | activity | name      | course | idnumber  | submissiontypetext | submissiontypefile |
      | peering | Only text | TEST   | peering1 | 2                  | 0                  |
    And I am on the "Only text" "peering activity" page
    And I follow "Switch to the submission phase"
    And I press "Continue"
  ...
  Scenario: File attachment only
    Given the following "activities" exist:
      | activity | name      | course | idnumber  | submissiontypetext | submissiontypefile |
      | peering | Only file | TEST   | peering1 | 0                  | 2                  |
    And I am on the "Only file" "peering activity" page
    And I follow "Switch to the submission phase"
    And I press "Continue"
    When I press "Add submission"
  ...
  Scenario: Neither submission type explicitly required
    Given the following "activities" exist:
      ...
      | peering | Neither required | TEST   | peering1 |
    And I am on the "Neither required" "peering activity" page
    And I follow "Switch to the submission phase"
    And I press "Continue"
    And I press "Add submission"
    And I set the field "Title" to "Test submission"
