@mod @mod_peering
Feature: peering assessment navigation display for reviewers
  As a reviewer
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | peering | peering 1 | C1     | 2                  |

  Scenario: Reviewers can navigate between submissions using save and show next button
    Given I am on the "Course 1" course page logged in as teacher1
    And I edit assessment form in peering "peering 1" as:
      | id_description__idx_0_editor | Aspect 1 |
      | id_description__idx_1_editor | Aspect 2 |
    And I change phase in peering "peering 1" to "Submission phase"
    # Add a submission for students to be assessed.
    And I am on the "peering 1" "peering activity" page logged in as student2
    And I add a submission in peering "peering 1" as:
      | Title              | Student 2 submission |
      | Submission content | Submission content   |
    And I am on the "peering 1" "peering activity" page logged in as student3
    And I add a submission in peering "peering 1" as:
      | Title              | Student 3 submission |
      | Submission content | Submission content   |
    # Allocate student1 as reviewer for other student submissions.
    And I am on the "peering 1" "peering activity" page logged in as teacher1
    And I allocate submissions in peering "peering 1" as:
      | Participant | Reviewer  |
      | Student 2   | Student 1 |
      | Student 3   | Student 1 |
    And I change phase in peering "peering 1" to "Assessment phase"
    When I am on the "peering 1" "peering activity" page logged in as student1
    And I press "Assess"
