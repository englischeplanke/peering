...
Feature: File types of the submission and feedback attachments can be limitted
  ...
  Scenario: Student submission attachments obey the list of allowed file types
    # Define peering to accept only images as submission attachments.
    Given I am on the "Testpeering" "peering activity editing" page logged in as teacher1
    ...
    And I upload "mod/peering/tests/fixtures/moodlelogo.png" file to "Attachment" filemanager
  ...
  Scenario: Overall feedback attachments obey the list of allowed file types
    # Define peering to accept only .php files as overall feedback attachments.
    ...
    And I am on the Testpeering "peering activity editing" page
    And I expand all fieldsets
    ...
    # So instead we try to trick the filemanager and bypass its checks, to be finally stopped by the
    # form field validation.
    And I upload "mod/peering/tests/fixtures/testable.php" file to "Attachment" filemanager
