@mod @mod_peering
Feature: peering submission and assessment
  In order to use peering activity
  As a student
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | peering | Testpeering | c1     | peering1 | 2                  | 1                  |
...
# teacher1 allocates reviewers and changes the phase to assessment
    ...
    Then I should see "peering submissions report"
...
# teacher1 makes sure he can see all peer grades
    And I am on the Testpeering "peering activity" page logged in as teacher1
    And I should see grade "52" for peering participant "Sam1" set by peer "Sam2"
    And I should see grade "60" for peering participant "Sam2" set by peer "Sam1"
    And I should see grade "-" for peering participant "Sam2" set by peer "Sam4"
    ...
    And I should see grade "68" for peering participant "Sam3" set by peer "Sam1"
