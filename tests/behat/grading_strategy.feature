@mod @mod_peering
Feature: peering grading strategy selection
  In order to verify that the assessment form is displayed correctly
  As a teacher
  I need to choose one of the four peering grading strategies
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | peering | C1     | peering 1 |
    And I am on the "peering 1" "peering activity editing" page logged in as teacher1
