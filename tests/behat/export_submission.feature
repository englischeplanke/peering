@mod @mod_peering
Feature: Exporting peering submissions and assessments to a portfolio
  In order to archive my peering contribution in a personal storage
  As a student or as a teacher
  I need to be able to export a peering submission and its associated assessments
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | peering | Testpeering | c1     | peering1 | 1                  |
    ...
    And I should see "peering submissions report"
  ...
  Scenario: Students can export their own submission to a portfolio.
    Given I am on the "Testpeering" "peering activity" page logged in as student1
  ...
  Scenario: If the portfolio API is disabled, the portfolio export button is not displayed.
    Given the following config values are set as admin:
      | enableportfolios | 0 |
    When I am on the "Testpeering" "peering activity" page logged in as student1
