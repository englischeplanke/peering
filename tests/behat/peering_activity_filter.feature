...
Feature: View work shop activity submissions report.
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | peering | Music history | Test peering description | C1     |

  Scenario Outline: Filter submissions report by last name/first name
    Given I am on the "Music history" "peering activity" page logged in as teacher1
    When I change phase in peering "Music history" to "<phase>"
  ...
  Scenario: Filter submissions report by last name/first name is hidden in the Setup phase.
    When I am on the "Music history" "peering activity" page logged in as teacher1
