@mod @mod_peering
Feature: peering submission removal
  ...
  Scenario: Students cannot delete their submissions if the submissions are not editable
    Given I am on the "Testpeering" "peering activity" page logged in as teacher1
  ...
  Scenario: Students cannot delete their submissions if the submissions are allocated for assessments
    Given I am on the "Testpeering" "peering activity" page logged in as student2
