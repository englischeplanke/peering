@mod @mod_peering
Feature: peering assessment with grade to pass
  In order to use peering activity
  As a teacher
  I need to be able to setup peering with require assessment grade and grade to pass
  ...
  @javascript
  Scenario: Setup peering with assessment grade and pass grade set
