@mod @mod_peering
Feature: peering grade submission and assessment
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | peering | Testpeering | Test peering description | c1     | peering1 | 2                  | 1                  | 10    | 5            | 1             | 2                     |

  Scenario: Assess submissions and gradings in peering with javascript enabled
    ...
    And I am on the Testpeering "peering activity" page logged in as student4
    And I should see "Submission1"
    And I should see "Sam1 Student1"
    And I assess submission "Sam1" in peering "Testpeering" as:
      | grade__idx_0            | 6 / 10            |
    ...
    And I should see grade "10.0" for peering participant "Sam1" set by peer "Sam2"
    And I should see grade "10.0" for peering participant "Sam1" set by peer "Sam3"
    And I should see grade "6.0" for peering participant "Sam1" set by peer "Sam4"
