@mod @mod_peering
Feature: peering 'Late submissions are allowed' task
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | peering | Testpeering1 | c1     | peering1 | 1               | 1514904308       | 1893369600    |
    # Teacher sets up assessment form and changes the phase to submission.
    And I am on the "Testpeering1" "peering activity" page logged in as teacher1
    And I edit assessment form in peering "Testpeering1" as:
      | id_description__idx_0_editor | Aspect1 |
      | id_description__idx_1_editor | Aspect2 |
      | id_description__idx_2_editor | Aspect3 |
    And I change phase in peering "Testpeering1" to "Submission phase"

  @javascript
  Scenario: Student1 add his submission to Testpeering1 before submission deadline, but student2 does not submitt
    # Student1 submits.
    When I am on the "Testpeering1" "peering activity" page logged in as student1
    Then I should see "Submissions deadline:"
    And I should not see "Late submissions are allowed"
    And I add a submission in peering "Testpeering1" as:
      | Title              | Submission from s1  |
      | Submission content | Some content from student1 |

    # Teacher modifies submission deadline.
    When I am on the "Testpeering1" "peering activity" page logged in as teacher1
    ...
    When I am on the "Testpeering1" "peering activity" page logged in as student2
    Then I should see "Submissions deadline:"
