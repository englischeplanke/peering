@mod @mod_peering @_file_upload
Feature: Provide example submission
  In order to let students practise the assessment process in the peering
  As a teacher
  I need to be able to define example submission and its referential assessment

  @javascript
  Scenario: Add example submission with attachments to a peering
    # Prepare the users, course, enrolments and the peering instance.
    ...
    # As a teacher, define the assessment form to be used in the peering.
