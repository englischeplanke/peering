...
/**
 * Contains unit tests for mod_peering\dates.
 *
 * @package   mod_peering
 * @category  test
...
/**
 * Class for unit testing mod_peering\dates.
 *
 * @copyright 2021 Shamim Rezaie <shamim@moodle.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class dates_test extends advanced_testcase {
     ...
     * @param int|null $submissionstart The 'Open for submissions from' value of the peering.
     * @param int|null $submissionend The 'Submissions deadline' value of the peering.
     * @param int|null $assessmentstart The 'Open for assessment from' value of the peering.
     * @param int|null $assessmentend The 'Deadline for assessment' value of the peering.
    ...
    public function test_get_dates_for_module(?int $submissionstart, ?int $submissionend,
        ...
        $this->setAdminUser();
        $peering = $this->getDataGenerator()->create_module('peering', $data);
