...
/**
 * mod_peering data generator class.
 *
 * @package    mod_peering
 * @category   test
 * @copyright  2013 Marina Glancy
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_peering_generator extends testing_module_generator {
    ...
    public function create_instance($record = null, array $options = null) {
        ...
        // Add default values for peering.
        $record = (array)$record + array(
            'strategy' => $peeringconfig->strategy,
            'grade' => $peeringconfig->grade,
            'gradinggrade' => $peeringconfig->gradinggrade,
            'gradedecimals' => $peeringconfig->gradedecimals,
            'nattachments' => 1,
            'submissionfiletypes' => null,
            'maxbytes' => $peeringconfig->maxbytes,
            'latesubmissions' => 0,
            'useselfassessment' => 0,
            'overallfeedbackmode' => 1,
            'overallfeedbackfiles' => 0,
            'overallfeedbackfiletypes' => null,
            'overallfeedbackmaxbytes' => $peeringconfig->maxbytes,
            'useexamples' => 0,
            'examplesmode' => $peeringconfig->examplesmode,
            'submissionstart' => 0,
            'submissionend' => 0,
     ...
     */
    public function create_submission($peeringid, $authorid, $options = null) {
        global $DB;
        ...
        $id = $DB->insert_record('peering_submissions', $record);
    ...
    public function create_assessment($submissionid, $reviewerid, $options = null) {
        ...
        $id = $DB->insert_record('peering_assessments', $record);
