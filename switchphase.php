...
$PAGE->set_url($peering->switchphase_url($phase), array('cmid' => $cmid, 'phase' => $phase));
...
echo $OUTPUT->confirm(get_string('switchphase' . $phase . 'info', 'peering'),
