...
/**
 * Strings for component 'peeringform_accumulative', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['privacy:metadata'] = 'The Accumulative grading plugin only stores the details of the assessment form. Actual personal data of how the form has been filled are stored by the peering module itself and are attached to exported assessments.';
