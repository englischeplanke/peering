 ...
 */
namespace peeringform_accumulative;

use peering;
use peering_accumulative_strategy;
...
require_once($CFG->dirroot . '/mod/peering/form/accumulative/lib.php');
...
class lib_test extends \advanced_testcase {
    ...
    /** @var testable_peering_accumulative_strategy instance of the strategy logic class being tested */
    protected $strategy;
    ...
    protected function setUp(): void {
        ...
        $peering = $this->getDataGenerator()->create_module('peering', array('strategy' => 'accumulative', 'course' => $course));
        $cm = get_fast_modinfo($course)->instances['peering'][$peering->id];
        $this->peering = new peering($peering, $cm, $course);
        $this->strategy = new testable_peering_accumulative_strategy($this->peering);
    }
 ...
 */
class testable_peering_accumulative_strategy extends peering_accumulative_strategy {
