...
/**
 * Provides the {@see peeringform_accumulative\provider_test} class.
 *
...
class provider_test extends provider_testcase {
    ...
    /**
     * Test {@link peeringform_accumulative\privacy\provider::export_assessment_form()} implementation.
     */
    public function test_export_assessment_form() {
        ...
        $this->dim1 = $DB->insert_record('peeringform_accumulative', [
        ...
        $this->dim2 = $DB->insert_record('peeringform_accumulative', [
            'peeringid' => $this->peering11->id,
            'sort' => 2,
        ...
        $form = $writer->get_data([
            ...
            get_string('pluginname', 'peeringform_accumulative'),
        ]);
