 ...
 */
class backup_peeringform_accumulative_subplugin extends backup_subplugin {
    ...
    protected function define_peering_subplugin_structure() {
        ...
        $subplugindimension = new backup_nested_element('peeringform_accumulative_dimension', array('id'), array(
        ...
        $subplugindimension->set_source_table('peeringform_accumulative', array('peeringid' => backup::VAR_ACTIVITYID));

        // id annotations
        $subplugindimension->annotate_ids('scale', 'grade');

        // file annotations
        $subplugindimension->annotate_files('peeringform_accumulative', 'description', 'id');
    ...
    protected function define_referenceassessment_subplugin_structure() {
        return $this->dimension_grades_structure('peeringform_accumulative_referencegrade');
    }
    ...
    protected function define_exampleassessment_subplugin_structure() {
        return $this->dimension_grades_structure('peeringform_accumulative_examplegrade');
    }
    ...
    protected function define_assessment_subplugin_structure() {
        return $this->dimension_grades_structure('peeringform_accumulative_grade');
    }
