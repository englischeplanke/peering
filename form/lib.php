...
interface peering_strategy {
     ...
     * are saved in peeringform_{strategyname} tables.
     *
     ...
     * If peeringid is null, it checks for any peering instance. If peeringid is provided,
