 ...
 */
class backup_peeringform_rubric_subplugin extends backup_subplugin {

    /**
     * Returns the assessment form definition to attach to 'peering' XML element
     */
    protected function define_peering_subplugin_structure() {
        ...
        $subpluginconfig = new backup_nested_element('peeringform_rubric_config', null, 'layout');
        $subplugindimension = new backup_nested_element('peeringform_rubric_dimension', array('id'), array(
            'sort', 'description', 'descriptionformat'));
        $subpluginlevel = new backup_nested_element('peeringform_rubric_level', array('id'), array(
        ...
        $subpluginconfig->set_source_table('peeringform_rubric_config', array('peeringid' => backup::VAR_ACTIVITYID));
        $subplugindimension->set_source_table('peeringform_rubric', array('peeringid' => backup::VAR_ACTIVITYID));
        $subpluginlevel->set_source_table('peeringform_rubric_levels', array('dimensionid' => backup::VAR_PARENTID));

        // file annotations
        $subplugindimension->annotate_files('peeringform_rubric', 'description', 'id');
    ...
    protected function define_referenceassessment_subplugin_structure() {
        return $this->dimension_grades_structure('peeringform_rubric_referencegrade');
    }
    ...
    protected function define_exampleassessment_subplugin_structure() {
        return $this->dimension_grades_structure('peeringform_rubric_examplegrade');
    }
    ...
    protected function define_assessment_subplugin_structure() {
        return $this->dimension_grades_structure('peeringform_rubric_grade');
    }
