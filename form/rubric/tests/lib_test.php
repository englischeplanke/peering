 ...
 */
namespace peeringform_rubric;

use peering;
use peering_rubric_strategy;
...
require_once($CFG->dirroot . '/mod/peering/form/rubric/lib.php');
...
class lib_test extends \advanced_testcase {
    ...
    protected function setUp(): void {
        ...
        $peering = $this->getDataGenerator()->create_module('peering', array('strategy' => 'rubric', 'course' => $course));
        $cm = get_fast_modinfo($course)->instances['peering'][$peering->id];
        $this->peering = new peering($peering, $cm, $course);
        $this->strategy = new testable_peering_rubric_strategy($this->peering);
 ...
 */
class testable_peering_rubric_strategy extends peering_rubric_strategy {
