 ...
 * @uses moodleform
 */
class peering_comments_assessment_form extends peering_assessment_form {
    ...
    protected function definition_inner(&$mform) {
        ...
        for ($i = 0; $i < $nodims; $i++) {
            // dimension header
            $dimtitle = get_string('dimensionnumber', 'peeringform_comments', $i+1);
            ...
            // comment
            $label = get_string('dimensioncommentfor', 'peeringform_comments', $dimtitle);
