...
/**
 * Provides the {@see peeringform_comments\privacy\provider_test} class.
 *
 ...
 */
namespace peeringform_comments\privacy;
...
class provider_test extends provider_testcase {
    ...
    /**
     * Test {@link peeringform_comments\privacy\provider::export_assessment_form()} implementation.
     */
    public function test_export_assessment_form() {
        ...
        $DB->set_field('peering', 'phase', 100, ['id' => $this->peering11->id]);

        $this->dim1 = $DB->insert_record('peeringform_comments', [
        ...
        $this->dim2 = $DB->insert_record('peeringform_comments', [
            'peeringid' => $this->peering11->id,
            'sort' => 2,
        ...
        $form = $writer->get_data([
            ...
            get_string('pluginname', 'peeringform_comments'),
        ]);
