 ...
 */
class backup_peeringform_comments_subplugin extends backup_subplugin {
    ...
    protected function define_peering_subplugin_structure() {
        ...
        $subplugindimension = new backup_nested_element('peeringform_comments_dimension', array('id'), array(
        ...
        $subplugindimension->set_source_table('peeringform_comments', array('peeringid' => backup::VAR_ACTIVITYID));

        // file annotations
        $subplugindimension->annotate_files('peeringform_comments', 'description', 'id');
    ...
    protected function define_referenceassessment_subplugin_structure() {
        return $this->dimension_grades_structure('peeringform_comments_referencegrade');
    }
    ...
    protected function define_exampleassessment_subplugin_structure() {
        return $this->dimension_grades_structure('peeringform_comments_examplegrade');
    }
    ...
    protected function define_assessment_subplugin_structure() {
        return $this->dimension_grades_structure('peeringform_comments_grade');
    }
