 ...
 * @uses moodleform
 */
class peering_numerrors_assessment_form extends peering_assessment_form {
    ...
    protected function definition_inner(&$mform) {
        ...
        for ($i = 0; $i < $nodims; $i++) {
            // dimension header
            $dimtitle = get_string('dimensionnumber', 'peeringform_numerrors', $i+1);
            ...
            $label = get_string('dimensiongrade', 'peeringform_numerrors');
            ...
            ), 'group_grade__idx_' . $i, get_string('yourassessmentfor', 'peering', $dimtitle), '<br />', false);
            $mform->addRule('group_grade__idx_' . $i, get_string('required'), 'required');

            // comment
            $label = get_string('dimensioncommentfor', 'peeringform_numerrors', $dimtitle);
