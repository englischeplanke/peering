 ...
 */
namespace peeringform_numerrors;

use peering;
use peering_numerrors_strategy;
...
require_once($CFG->dirroot . '/mod/peering/form/numerrors/lib.php');
...
class lib_test extends \advanced_testcase {
    ...
    protected function setUp(): void {
        ...
        $peering = $this->getDataGenerator()->create_module('peering', array('strategy' => 'numerrors', 'course' => $course));
        $cm = get_fast_modinfo($course)->instances['peering'][$peering->id];
        $this->peering = new peering($peering, $cm, $course);
        $this->strategy = new testable_peering_numerrors_strategy($this->peering);
    }
 ...
 */
class testable_peering_numerrors_strategy extends peering_numerrors_strategy {
