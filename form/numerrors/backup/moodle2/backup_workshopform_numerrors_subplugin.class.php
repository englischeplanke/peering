 ...
 */
class backup_peeringform_numerrors_subplugin extends backup_subplugin {
    ...
    protected function define_peering_subplugin_structure() {
        ...
        $subpluginmap = new backup_nested_element('peeringform_numerrors_map', array('id'), array(
            'nonegative', 'grade'));
        $subplugindimension = new backup_nested_element('peeringform_numerrors_dimension', array('id'), array(
        ...
        $subpluginmap->set_source_table('peeringform_numerrors_map', array('peeringid' => backup::VAR_ACTIVITYID));
        $subplugindimension->set_source_table('peeringform_numerrors', array('peeringid' => backup::VAR_ACTIVITYID));

        // file annotations
        $subplugindimension->annotate_files('peeringform_numerrors', 'description', 'id');
    ...
    protected function define_referenceassessment_subplugin_structure() {
        return $this->dimension_grades_structure('peeringform_numerrors_referencegrade');
    }
    ...
    protected function define_exampleassessment_subplugin_structure() {
        return $this->dimension_grades_structure('peeringform_numerrors_examplegrade');
    }
    ...
    protected function define_assessment_subplugin_structure() {
        return $this->dimension_grades_structure('peeringform_numerrors_grade');
    }
