...
/**
 * Strings for component 'peering', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    mod_peering
 * @copyright  2024 Johann Mellin <johann.mellin@tuhh.de>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
$string['publishgradessettings'] = 'Writing results to Moodle grade book';
$string['dopublishgrades'] = 'This will write all grades to the moodle grade book.';
$string['publishgrades'] = 'Publish Grades';
$string['autonomousgroupssettings'] = 'Autonomous groups settings';
$string['autonomousgroups'] = 'Set autonomous groups';
$string['autonomousgroups_desc'] = 'Let the peers grade each other';
...
$string['configexamplesmode'] = 'Default mode of examples assessment in peerings';
$string['configgrade'] = 'Default maximum grade for submission in peerings';
$string['configgradedecimals'] = 'Default number of digits that should be shown after the decimal point when displaying grades.';
$string['configgradinggrade'] = 'Default maximum grade for assessment in peerings';
$string['configmaxbytes'] = 'Default maximum submission file size for all peerings on the site (subject to course limits and other local settings)';
$string['configstrategy'] = 'Default grading strategy for peerings';
$string['createsubmission'] = 'Add submission';
$string['crontask'] = 'Background processing for peering module';
...
$string['gradegivento'] = '&gt;';
$string['gradeitemassessment'] = '{$a->peeringname} (assessment)';
$string['gradeitemsubmission'] = '{$a->peeringname} (submission)';
$string['gradeover'] = 'Override grade for submission';
$string['gradesreport'] = 'peering grades report';
...
$string['groupnoallowed'] = 'You are not allowed to access any group in this peering';
$string['chooseuser'] = 'Choose user...';
$string['iamsure'] = 'Yes, I am sure';
$string['indicator:cognitivedepth'] = 'peering cognitive';
$string['indicator:cognitivedepth_help'] = 'This indicator is based on the cognitive depth reached by the student in a peering activity.';
$string['indicator:cognitivedepthdef'] = 'peering cognitive';
$string['indicator:cognitivedepthdef_help'] = 'The participant has reached this percentage of the cognitive engagement offered by the peering activities during this analysis interval (Levels = No view, View, Submit, View feedback, Comment on feedback, Resubmit after viewing feedback)';
$string['indicator:cognitivedepthdef_link'] = 'Learning_analytics_indicators#Cognitive_depth';
$string['indicator:socialbreadth'] = 'peering social';
$string['indicator:socialbreadth_help'] = 'This indicator is based on the social breadth reached by the student in a peering activity.';
$string['indicator:socialbreadthdef'] = 'peering social';
$string['indicator:socialbreadthdef_help'] = 'The participant has reached this percentage of the social engagement offered by the peering activities during this analysis interval (Levels = No participation, Participant alone, Participant with others)';
...
Students obtain two grades in a peering activity - a grade for their submission and a grade for their assessment of their peers\' submissions. Both grades are recorded in the gradebook.';
$string['modulename_link'] = 'mod/peering/view';
$string['modulenameplural'] = 'peerings';
$string['myassessments'] = 'My assessments';
$string['mysubmission'] = 'My submission';
$string['nattachments'] = 'Maximum number of submission attachments';
$string['noexamples'] = 'No examples yet in this peering';
...
$string['page-mod-peering-x'] = 'Any peering module page';
...
$string['pluginadministration'] = 'peering administration';
$string['pluginname'] = 'Peering';
$string['prepareexamples'] = 'Prepare example submissions';
$string['previewassessmentform'] = 'Preview';
$string['privacy:metadata:aggregatedgradinggrade'] = 'Aggregated grade for all assessments made by the user in the given peering activity';
...
$string['privacy:metadata:preference:viewlet-allsubmissions-collapsed'] = 'The collapsed/expanded state for the \'peering submissions report\' viewlet.';
...
$string['privacy:metadata:preference:viewlet-cleargrades-collapsed'] = 'The collapsed/expanded state for the \'peering toolbox\' viewlet.';
...
$string['privacy:metadata:preference:viewlet-gradereport-collapsed'] = 'The collapsed/expanded state for the \'peering grades report\' viewlet.';
...
$string['privacy:metadata:published'] = 'Whether the submission should be published to all participants once the peering is closed';
...
$string['privacy:metadata:subsystem:corefiles'] = 'peering module stores files embedded in / attached to the submission text';
$string['privacy:metadata:subsystem:coreplagiarism'] = 'peering module has inbuilt support for plagiarism prevention systems';
...
$string['privacy:metadata:peeringaggregations'] = 'Holds aggregated grades for assessment';
$string['privacy:metadata:peeringassessments'] = 'Holds information about allocated assessments of peering module submissions';
$string['privacy:metadata:peeringgrades'] = 'Holds information about how the assessment forms were filled with grades and comments';
$string['privacy:metadata:peeringid'] = 'ID of the peering activity';
$string['privacy:metadata:peeringsubmissions'] = 'Holds information about peering module submissions';
...
$string['publishsubmission_help'] = 'Published submissions are available to the others when the peering is closed.';
$string['reassess'] = 'Re-assess';
$string['receivedgrades'] = 'Grades received';
$string['recentassessments'] = 'peering assessments:';
$string['recentsubmissions'] = 'peering submissions:';
...
$string['resetphase_help'] = 'If enabled, all peerings will be put into the initial setup phase.';
...
$string['search:activity'] = 'peering - activity information';
...
$string['strategyhaschanged'] = 'The peering grading strategy has changed since the form was opened for editing.';
...
$string['submissionendswitch_help'] = 'If the submissions deadline is specified and this box is checked, the peering will automatically switch to the assessment phase after the submissions deadline.

If you enable this feature, it is recommended to set up the scheduled allocation method, too. If the submissions are not allocated, no assessment can be done even if the peering itself is in the assessment phase.';
...
$string['submissiontypedisabled'] = 'This submission type is disabled for this peering.';
$string['submissiontypes'] = 'Submission types';
$string['submissionsreport'] = 'peering submissions report';
$string['submittednotsubmitted'] = 'Submitted ({$a->submitted}) / not submitted ({$a->notsubmitted})';
$string['subplugintype_peeringallocation'] = 'Submissions allocation method';
$string['subplugintype_peeringallocation_plural'] = 'Submissions allocation methods';
$string['subplugintype_peeringeval'] = 'Grading evaluation method';
$string['subplugintype_peeringeval_plural'] = 'Grading evaluation methods';
$string['subplugintype_peeringform'] = 'Grading strategy';
$string['subplugintype_peeringform_plural'] = 'Grading strategies';
...
$string['switchphase10info'] = 'You are about to switch the peering into the <strong>Setup phase</strong>. In this phase, users cannot modify their submissions or their assessments. Teachers may use this phase to change peering settings, modify the grading strategy or tweak assessment forms.';
$string['switchphase20'] = 'Switch to the submission phase';
$string['switchphase20info'] = 'You are about to switch the peering into the <strong>Submission phase</strong>. Students may submit their work during this phase (within the submission access control dates, if set). Teachers may allocate submissions for peer review.';
$string['switchphase30'] = 'Switch to the assessment phase';
$string['switchphase30auto'] = 'peering will automatically switch into the assessment phase after {$a->daydatetime} ({$a->distanceday})';
$string['switchphase30info'] = 'You are about to switch the peering into the <strong>Assessment phase</strong>. In this phase, reviewers may assess the submissions they have been allocated (within the assessment access control dates, if set).';
$string['switchphase40'] = 'Switch to the evaluation phase';
$string['switchphase40info'] = 'You are about to switch the peering into the <strong>Grading evaluation phase</strong>. In this phase, users cannot modify their submissions or their assessments. Teachers may use the grading evaluation tools to calculate final grades and provide feedback for reviewers.';
$string['switchphase50'] = 'Close peering';
$string['switchphase50info'] = 'You are about to close the peering. This will result in the calculated grades appearing in the gradebook. Students may view their submissions and their submission assessments.';
...
$string['taskintro'] = 'Set the peering description';
$string['tasksubmit'] = 'Submit your work';
$string['tasktodo'] = 'Task to do';
$string['toolbox'] = 'peering toolbox';
$string['undersetup'] = 'The peering is currently being set up. Please wait until it is switched to the next phase.';
...
$string['userplan'] = 'peering planner';
$string['userplancurrentphase'] = 'Current phase';
$string['userplan_help'] = 'The peering planner displays all phases of the activity and lists the tasks for each phase. The current phase is highlighted and task completion is indicated with a tick.';
$string['userplanaccessibilityskip'] = 'Skip to current tasks';
$string['userplanaccessibilitytitle'] = 'peering timeline with {$a} phases';
...
$string['viewpeeringsummary'] = 'View peering summary';
$string['weightinfo'] = 'Weight: {$a}';
$string['withoutsubmission'] = 'Reviewer without own submission';
$string['peering:addinstance'] = 'Add a new peering';
$string['peering:allocate'] = 'Allocate submissions for review';
$string['peering:editdimensions'] = 'Edit assessment forms';
$string['peering:exportsubmissions'] = 'Export submissions';
$string['peering:deletesubmissions'] = 'Delete submissions';
$string['peering:ignoredeadlines'] = 'Ignore time restrictions';
$string['peering:manageexamples'] = 'Manage example submissions';
$string['peeringname'] = 'peering name';
$string['peering:overridegrades'] = 'Override calculated grades';
$string['peering:peerassess'] = 'Peer assess';
$string['peering:publishsubmissions'] = 'Publish submissions';
$string['peering:submit'] = 'Submit';
$string['peering:switchphase'] = 'Switch phase';
$string['peering:view'] = 'View peering';
$string['peering:viewallassessments'] = 'View all assessments';
$string['peering:viewallsubmissions'] = 'View all submissions';
$string['peering:viewauthornames'] = 'View author names';
$string['peering:viewauthorpublished'] = 'View authors of published submissions';
$string['peering:viewpublishedsubmissions'] = 'View published submissions';
$string['peering:viewreviewernames'] = 'View reviewer names';
