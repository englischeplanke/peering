...
/**
 * Strings for component 'peeringeval_best', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    peeringeval
 * @subpackage best
...
$string['privacy:metadata'] = 'The Comparison with the best assessment plugin does not store any personal data. Actual personal data user\'s grades are stored by the peering module itself and are attached to the exported submissions and assessments data.';
