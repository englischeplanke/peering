 ...
 *
 * @package    peeringeval_best
 * @category   test
 * @copyright  2024 Johann Mellin <johann.mellin@tuhh.de>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
namespace peeringeval_best;

use peering;
use peering_best_evaluation;
...
require_once($CFG->dirroot . '/mod/peering/eval/best/lib.php');
...
class lib_test extends \advanced_testcase {
    ...
    protected function setUp(): void {
        ...
        $peering = $this->getDataGenerator()->create_module('peering', array('evaluation' => 'best', 'course' => $course));
        $cm = get_fast_modinfo($course)->instances['peering'][$peering->id];
        $this->peering = new peering($peering, $cm, $course);
        $this->evaluator = new testable_peering_best_evaluation($this->peering);
    }
    ...
    public function test_assessments_distance_zero_variance() {
        ...
        // Simulate structure returned by {@link peering_best_evaluation::prepare_data_from_recordset()}
        $assessments = array(
        ...
        // Process assessments in the same way as in the {@link peering_best_evaluation::process_assessments()}
 ...
 */
class testable_peering_best_evaluation extends peering_best_evaluation {
