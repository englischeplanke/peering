...
class assessment_exporter extends exporter {
    ...
    protected function get_other_values(renderer_base $output) {
        ...
        $values['feedbackcontentfiles'] =
                external_util::get_area_files($context->id, 'mod_peering', 'overallfeedback_content', $this->data->id);
        $values['feedbackattachmentfiles'] =
                external_util::get_area_files($context->id, 'mod_peering', 'overallfeedback_attachment', $this->data->id);
