...
class submission_exporter extends exporter {
    ...
    protected static function define_properties() {
        ...
        return array(
            ...
            'peeringid' => array(
                'type' => PARAM_INT,
                'description' => 'The id of the peering instance.',
            ),
            'example' => array(
                'type' => PARAM_BOOL,
                'null' => NULL_ALLOWED,
            ...
            'published' => array(
                ...
                'null' => NULL_ALLOWED,
                'default' => false,
                'description' => 'Shall the submission be available to other when the peering is closed.',
            ),
            'late' => array(
                'type' => PARAM_INT,
                'default' => 0,
    ...
    protected function get_other_values(renderer_base $output) {
        ...
        if (!empty($this->data->content)) {
            $values['contentfiles'] =
                external_util::get_area_files($context->id, 'mod_peering', 'submission_content', $this->data->id);
        }

        $values['attachmentfiles'] =
                external_util::get_area_files($context->id, 'mod_peering', 'submission_attachment', $this->data->id);
