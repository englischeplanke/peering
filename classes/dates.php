...
/**
 * Contains the class for fetching the important dates in mod_peering for a given module instance and a user.
 *
 * @package   mod_peering
...
/**
 * Class for fetching the important dates in mod_peering for a given module instance and a user.
 *
 * @copyright 2021 Shamim Rezaie <shamim@moodle.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class dates extends activity_dates {
    ...
    /**
     * Returns a list of important dates in mod_peering
     *
     * @return array
     */
    protected function get_dates(): array {
        ...
        if ($submissionstart) {
            ...
            $dates[] = [
                ...
                'label' => get_string($openlabelid, 'mod_peering'),
        ...
        if ($submissionend) {
            ...
            $dates[] = [
                ...
                'label' => get_string($closelabelid, 'mod_peering'),
