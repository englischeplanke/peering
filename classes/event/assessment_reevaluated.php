...
/**
 * The mod_peering assessment_reevaluated event.
 *
 * @package    mod_peering
...
/**
 * The mod_peering assessment_reevaluated event class.
 *
...
class assessment_reevaluated extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has had their assessment attempt reevaluated for the peering with " .
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'peering', 'update aggregate grade', 'view.php?id=' . $this->contextinstanceid,
    ...
    public static function get_name() {
        return get_string('eventassessmentreevaluated', 'mod_peering');
    }
