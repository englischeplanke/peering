...
/**
 * The mod_peering submission reassessed event.
 *
 * @package    mod_peering
...
/**
 * The mod_peering submission reassessed event class.
 *
...
class submission_reassessed extends \core\event\base {
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'peering', 'update assessment', 'assessment.php?asid=' . $this->objectid,
    ...
    public static function get_name() {
        return get_string('eventsubmissionreassessed', 'mod_peering');
    }
