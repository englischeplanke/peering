...
/**
 * The mod_peering assessable uploaded event.
 *
 * @package    mod_peering
...
/**
 * The mod_peering assessable uploaded event class.
 *
 * @package    mod_peering
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class assessable_uploaded extends \core\event\assessable_uploaded {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has uploaded the submission with id '$this->objectid' " .
            "to the peering activity with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventassessableuploaded', 'mod_peering');
    }
