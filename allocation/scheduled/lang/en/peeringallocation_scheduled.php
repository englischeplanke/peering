...
/**
 * Strings for the peering's scheduled allocator
 *
...
$string['scheduledallocationsettings_help'] = 'If enabled, the scheduled allocation method will automatically allocate submissions for the assessment at the end of the submission phase. The end of the phase can be defined in the peering setting \'Submissions deadline\'.
...
Note that the scheduled allocation is *not* executed if you manually switch the peering into the assessment phase before the submissions deadline. You have to allocate submissions yourself in that case. The scheduled allocation method is particularly useful when used together with the automatic phase switching feature.';
$string['pluginname'] = 'Scheduled allocation';
$string['privacy:metadata'] = 'The Scheduled allocation plugin does not store any personal data. Actual personal data about who is going to assess whom are stored by the peering module itself and they form basis for exporting the assessments details.';
...
$string['resultfaileddeadline'] = 'peering does not have the submissions deadline defined';
$string['resultfailedphase'] = 'peering not in the submission phase';
