...
namespace peeringallocation_random;

use peering;
use peering_random_allocator;
...
require_once($CFG->dirroot . '/mod/peering/allocation/random/lib.php');
...
class allocator_test extends \advanced_testcase {
    ...
    protected function setUp(): void {
        ...
        $this->allocator = new testable_peering_random_allocator($this->peering);
    }
 ...
 */
class testable_peering_random_allocator extends peering_random_allocator {
