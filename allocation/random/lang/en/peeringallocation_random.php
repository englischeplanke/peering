...
/**
 * Strings for component 'peeringallocation_random', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['nogroupusers'] = '<p>Warning: If the peering is in \'visible groups\' mode or \'separate groups\' mode, then users MUST be part of at least one group to have peer-assessments allocated to them by this tool. Non-grouped users can still be given new self-assessments or have existing assessments removed.</p>
...
$string['privacy:metadata'] = 'The Random allocation plugin does not store any personal data. Actual personal data about who is going to assess whom are stored by the peering module itself and they form basis for exporting the assessments details.';
