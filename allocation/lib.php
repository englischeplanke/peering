 ...
 * peering_assessments table.
 */
interface peering_allocator {
     ...
     *
     * @param stdClass $wsoutput peering module renderer can be used
 ...
 */
class peering_allocation_result implements renderable {
    ...
    /** @var peering_allocator the instance of the allocator that produced this result */
    protected $allocator;
     ...
     *
     * @param peering_allocator $allocator
     */
    public function __construct(peering_allocator $allocator) {
